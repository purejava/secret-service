...
public class Util {
     ...
     * that was created.<br>
     *
     * <p>Or an <code>ArrayList<DbusPaths></code> of the objects, the prompt was executed for, e.g. the
     * list paths of the Collections that were unlocked.</p><br>
     * <p>When something went wrong on executing the prompt or when the prompt was dismissed, "/" is returned.</p>
     */
    public static Object promptAndGetResult(DBusPath path) {
